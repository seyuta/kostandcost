<div class="modal fade" id="modal-pay-{{$occupant->payment_id}}">
            ...
            <div class="modal-body">
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <form action="/payments/{{$occupant->payment_id}}" method="POST" data-parsley-validate="true" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="row m-b-0">
                                <div class="col-md-4 col-xs-12">
                                    <dl>
                                      ...
                                      <dd>Rp. {{number_format(($occupant->payments->bill - $occupant->payments->dp_booking),0,",",".")}},-</dd>
                                      <br>
